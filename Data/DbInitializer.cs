...
namespace AdvancedProjectMVC.Data
{
    public class DbInitializer
    {
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            {
                new Administrator{FirstName="Alex",LastName="B",Email="alexb@school.ca",DOB=DateTime.Parse("1989-01-01"),DateRegistered=DateTime.Parse("2001-01-01")},
            };
            ...
            {
                new Instructor{FirstName="Ian",LastName="Moser",Email="ianm@school.ca",DOB=DateTime.Parse("1965-03-03"),DateRegistered=DateTime.Parse("1998-05-23")},
            };
            ...
            {
            new Student{FirstName="Carson",LastName="Alexander",Email="calexander@school.ca",DOB=DateTime.Parse("1989-03-01"),DateRegistered=DateTime.Parse("2005-09-01")},
            ...
            {
/*            new Enrollment{StudentID=1,CourseID=1,Grade=88},
