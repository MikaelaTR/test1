        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SchoolProgramId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_SchoolPrograms_SchoolProgramId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseSchoolProgram", x => new { x.CoursesID, x.ProgramsId });
                    table.ForeignKey(
                        name: "FK_CourseSchoolProgram_Courses_CoursesID",
                        column: x => x.CoursesID,
                        principalTable: "Courses",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseSchoolProgram_SchoolPrograms_ProgramsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserServer", x => new { x.ApplicationUsersId, x.ServersId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserServer_AspNetUsers_ApplicationUsersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServerMembers_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TeachingAssignments_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_SchoolProgramId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseSchoolProgram_ProgramsId",
                table: "CourseSchoolProgram",
                column: "ProgramsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServerMembers_ApplicationUserId",
                table: "ServerMembers",
                column: "ApplicationUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeachingAssignments_ApplicationUserId",
